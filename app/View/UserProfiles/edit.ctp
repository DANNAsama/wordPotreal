...
<div style="margin:120px;">
  ...
  <form>
   <div class="span2" style="float:left;">
      ...
      <div style="clear:both;margin-top:20px;"><input type="text" name="data[UserProfile][nickname]" style="width:180px;" value="<?php echo $userprofile["UserProfile"]["nickname"]; ?>">
      </div>
    </div>
    <div style="float:left;margin-left:20px;">
      ...
      <textarea name="data[UserProfile][description]" cols="35" rows="10"><?php echo $userprofile["UserProfile"]["description"]; ?></textarea>
        <div class="span2" style="clear:both;">
            <button class="btn" type="submit" onclick="location.href='<?php echo $this->html->url('http://maitake.sakura.ne.jp/wordPot/user_profiles/index?id=$user_id'); ?>'" style="background:#ffbd66;margin-top:10px;">編集</button>
        </div>
      </div>
    </div> 
  </form>
